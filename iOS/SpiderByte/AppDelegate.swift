...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        FirebaseApp.configure() // Setup Firebase Database
        Database.database().isPersistenceEnabled = true // Cache Firebase data
        UserDefaults.standard.setValue(false, forKey: "_UIConstraintBasedLayoutLogUnsatisfiable")
        
        //Additional code for App Tutorial
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool {
        ...
        MSALPublicClientApplication.handleMSALResponse(url) // Receive Microsoft Callback
        return true
    }
